...
class Paraffin extends ArrayObject {
	 ...
	 * Assumed generally to be an auto incrementing numeric, but there's no reason
	 * you can't use natural or other keys with this library, as long as you
	 * write your own logic to create key values.
	 *
	 * @var string $id_name
	 */
